Ext.define('digilib.view.dataview.Dataviewbookmark', {
    ...
    items: [{
        ...
        itemTpl:'<center><img class="photo" src="'+digilib.util.IMAGE.getPhppath()+'{gambar}"></center><center><div id = "coba" class = "keteragan">{judul}<br></div>'+
                '</center><center><button class="button"><span><a href="'+digilib.util.PDF.getPhppath()+'?file=jakfar.pdf#zoom=40" style="width: 100%; height:2000px; "">Baca</a></span></button>'+
                '</center><hr></div>',
