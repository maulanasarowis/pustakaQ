...
$output = array();
$success = 'false';
$query="select * from item,biblio,loan WHERE item.item_code=loan.item_code AND biblio.biblio_id=item.biblio_id And loan.member_id='$kode'" or die("Cannot access item");
